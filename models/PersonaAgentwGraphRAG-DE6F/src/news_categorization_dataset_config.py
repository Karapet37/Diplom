...
DATASET_CONFIGS = {
    'news': DatasetConfig(
        ...
        train_file='../data/news_categorize/user_others.json',  # Training data for GraphRAG memory
        test_file='../data/news_categorize/user_top_100_history.json',  # Test data for evaluation
